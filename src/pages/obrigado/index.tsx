                    ...
                    <div className="lg:mt-8 flex items-center justify-center gap-x-8 lg:gap-x-32">
                        <div>
                            ...
                            <Link
                                ...
                                className="inline-block rounded-3xl border border-transparent text-center bg-verde px-8 lg:px-16 py-2 lg:py-4 text-lg font-medium text-black hover:bg-laranja hover:scale-105 transition duration-500 ease-in-out"
                            >
                                Grupo WhatsApp
                            </Link>
                        </div>
                        <div>
                            <Link
                                ...
                                className="inline-block rounded-3xl border border-transparent text-center bg-laranja px-8 lg:px-16 py-2 lg:py-4 text-lg font-medium text-black hover:bg-verde hover:scale-105 transition duration-500 ease-in-out"
                            >
                                Iniciar Curso
                            </Link>
                        </div>
